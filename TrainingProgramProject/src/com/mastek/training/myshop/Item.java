...
public class Item implements Comparable<Item> //provides the default sorting for TreeSet
{
	private int itemId;
	...
	public int compareTo(Item anotherItem) {
		// return a number
		//+ve: current object is greater than another item
		//0: current object is equal to another item
		//-ve: current object is less than another item
